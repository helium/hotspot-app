  ...
  translations: {
    en: {
      ...
      power: [
        ...
        'The FinestraMiner will show a blue LED light once it’s powered on.',
      ],
      bluetooth: [
        'Bluetooth is automatically enabled for 10 minutes after the FinestraMiner is powered on. Otherwise, press the pairing button twice.\n\nAfter connecting to the Internet, the FinestraMiner may automatically update itself. This could take up to 30 minutes. Please be patient.',
        'FinestraMiner can take up to 2 minutes to fully boot up.',
      ],
    },
    ja: {
      diagnostic:
