  ...
  translations: {
    en: {
      ...
      power: [
        ...
        'The COTX Gateway Miner will show a red LED light once it’s powered on.',
      ],
      bluetooth: [
        'There is no pairing button on the COTX Gateway Miner.',
        'Bluetooth is automatically enabled for 5 minutes after the COTX Gateway Miner is powered on.\n\nHotspot can take up to 1 minute to fully boot up.',
      ],
    },
    ja: {
      diagnostic:
      ...
      power: [
        ...
        'COTX Gateway Minerの電源がオンになると、赤いLEDライトが点きます。',
      ],
      bluetooth: [
        'COTX Gateway Minerにペアリングボタンはありません。',
        'COTX Gateway Minerの電源がオンになると、自動的にBluetoothが5分間有効になります。\n\nHotspotが完全に起動するまでに最大で1分かかる場合があります。',
      ],
    },
    ko: {
      diagnostic:
      ...
      power: [
        ...
        '전원이 켜지면 COTX Gateway Miner에 빨간색 LED 표시등이 표시됩니다.',
      ],
      bluetooth: [
        'COTX Gateway Miner에는 페어링 버튼이 없습니다.',
        'COTX Gateway Miner의 전원이 켜진 후 5분 동안 Bluetooth가 자동으로 활성화됩니다.\n\nHotspot이 완전히 부팅되는 데 최대 1분이 소요될 수 있습니다.',
      ],
    },
    zh: {
      diagnostic:
      ...
      power: [
        '将电源适配器插入靠窗的插座。',
        '开机后，COTX Gateway Miner 将亮起红色 LED 指示灯。',
      ],
      bluetooth: [
        'COTX Gateway Miner 上没有配对按钮。',
        'COTX Gateway Miner 开机后，蓝牙会自动启用 5 分钟。\n\nHotspot 最多需要 1 分钟即可完全启动。',
      ],
    },
  },
  icon: HotspotIcon,
  antenna: { us: ANTENNAS.COTX_US, default: ANTENNAS.COTX_EU },
} as MakerHotspot

// const COTX_V2 = {
//   name: 'COTX v2 Hotspot',
//   onboardType:'QR',
//   translations: {
//     en: {
...
export default { COTX_V1 /* , COTX_V2 */ }
