export default {
  ...
  hotspot_setup: {
    ...
    wifi_scan: {
      ...
      connected: 'Hotspotは<green>オンライン</green>になっており、%{network}に接続されています。',
      scan_fail_subtitle:
    ...
    error: {
      ...
      alertMessage: 'サーバーへのリクエストがタイムアウトしたため、現在Hotspotを追加できません。\n\nsupport@helium.comに連絡し、MACアドレス%{mac}を伝えてください。',
    },
  },
  account_import: {
    word_entry: {
  ...
  send: {
    ...
    scan: {
      ...
      burn: 'HNTをDCにバーン',
      burn_description: 'HNTをData Creditにバーンして、デバイスネットワークの接続料金を支払うことができます。DCは転送できません。',
      view: 'QRコードを表示',
      view_description: 'QRコードを共有して、他のユーザーからHNTを入金するか受け取ります。',
      learn_more: '詳細',
    }
  },
  more: {
  ...
  checklist: {
    ...
    witness: {
      success: 'このHotspotはウィットネスリストに{{count}}個のHotspotがあります。',
      success_plural:
    ...
    challengee: {
      success: 'Hotspotは{{count}}ブロック前のChallengeに最後に追加されました。',
      success_plural:
