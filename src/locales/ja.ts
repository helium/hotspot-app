export default {
  ...
  checklist: {
    ...
    challenger: {
      ...
      fail:
        'HotspotはまだChallengeを発行していません。Hotspotは360ブロックごと（約6時間ごと）にChallengeを自動的に作成します。',
      title: 'Challengeを作成',
    },
    challenge_witness: {
    ...
    challengee: {
      ...
      success_plural:
        'Hotspotは{{count}}ブロック前のChallengeに最後に追加されました。',
      fail:
        'オンラインHotspotは360ブロック（6時間）ごとにChallengeが作成され、次にChallengeが作成されるまでに時間がかかる場合があります。',
      title: 'Challengeを渡す',
    },
    data_transfer: {
