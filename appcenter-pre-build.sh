...
echo ONE_SIGNAL_APP_ID=$ONE_SIGNAL_APP_ID
...
echo STAKING_API_BASE_URL=$STAKING_API_BASE_URL
echo STAKING_API_BASE_URL=$STAKING_API_BASE_URL >> .env

echo WALLET_API_BASE_URL=$WALLET_API_BASE_URL
echo WALLET_API_BASE_URL=$WALLET_API_BASE_URL >> .env

echo STAKING_TOKEN=$STAKING_TOKEN
